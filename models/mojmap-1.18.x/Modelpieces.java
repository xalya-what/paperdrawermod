...
public class Modelpieces<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pieces"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mainhead = partdefinition.addOrReplaceChild("mainhead",
				CubeListBuilder.create().texOffs(33, 0)
						.addBox(-5.0F, -14.0F, -1.0F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 28)
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(12, 34)
						.addBox(4.0F, -13.0F, -1.0F, 1.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 28)
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(16, 34)
						.addBox(-5.0F, -13.0F, -1.0F, 1.0F, 13.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
