...
import net.mcreator.paperdrawermod.world.features.treedecorators.PaperEndTrunkDecorator;
import net.mcreator.paperdrawermod.world.features.treedecorators.PaperEndLeaveDecorator;
import net.mcreator.paperdrawermod.world.features.treedecorators.PaperEndFruitDecorator;
...
public class PaperEndBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("paperdrawermod:tree_paper_end",
						FeatureUtils.register("paperdrawermod:tree_paper_end", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										BlockStateProvider.simple(PaperdrawermodModBlocks.PAPER_BLOCK_END.get().defaultBlockState()),
										new StraightTrunkPlacer(7, 2, 0),
										BlockStateProvider.simple(PaperdrawermodModBlocks.PAPER_BLOCK_END.get().defaultBlockState()),
										new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
										.decorators(ImmutableList.of(PaperEndLeaveDecorator.INSTANCE, PaperEndTrunkDecorator.INSTANCE,
												PaperEndFruitDecorator.INSTANCE))
										.build()),
						List.of(CountPlacement.of(1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING),
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("paperdrawermod:grass_paper_end", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("paperdrawermod:flower_paper_end", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
