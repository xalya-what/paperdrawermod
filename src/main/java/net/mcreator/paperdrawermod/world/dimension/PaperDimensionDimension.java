...
package net.mcreator.paperdrawermod.world.dimension;
...
public class PaperDimensionDimension {
	@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
	public static class Fixers {
		@SubscribeEvent
		public static void registerFillerBlocks(FMLCommonSetupEvent event) {
			Set<Block> replaceableBlocks = new HashSet<>();
			replaceableBlocks.add(PaperdrawermodModBlocks.PAPER_BLOCK.get());
			replaceableBlocks.add(PaperdrawermodModBlocks.PAPER_BLOCK.get());
			replaceableBlocks.add(PaperdrawermodModBlocks.PAPER_BLOCK.get());
			event.enqueueWork(() -> {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("paperdrawermod:paper_dimension"), customEffect));
		}
	}
}
