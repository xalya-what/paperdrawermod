...
public class PaperBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final PaperBiomeLeaveDecorator INSTANCE = new PaperBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("paper_biome_tree_leave_decorator");
