...
public class PaperBiomeTrunkDecorator extends TrunkVineDecorator {
	public static final PaperBiomeTrunkDecorator INSTANCE = new PaperBiomeTrunkDecorator();
	public static com.mojang.serialization.Codec<PaperBiomeTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("paper_biome_tree_trunk_decorator");
