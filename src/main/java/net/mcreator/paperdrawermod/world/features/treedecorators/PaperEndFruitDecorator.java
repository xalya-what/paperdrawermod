...
public class PaperEndFruitDecorator extends CocoaDecorator {
	public static final PaperEndFruitDecorator INSTANCE = new PaperEndFruitDecorator();
	public static com.mojang.serialization.Codec<PaperEndFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("paper_end_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public PaperEndFruitDecorator() {
		super(0.2f);
	}
