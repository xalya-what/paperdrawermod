...
public class PaperEndLeaveDecorator extends LeaveVineDecorator {
	public static final PaperEndLeaveDecorator INSTANCE = new PaperEndLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("paper_end_tree_leave_decorator");
