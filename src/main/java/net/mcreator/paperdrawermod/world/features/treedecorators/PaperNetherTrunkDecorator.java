...
public class PaperNetherTrunkDecorator extends TrunkVineDecorator {
	public static final PaperNetherTrunkDecorator INSTANCE = new PaperNetherTrunkDecorator();
	public static com.mojang.serialization.Codec<PaperNetherTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("paper_nether_tree_trunk_decorator");
